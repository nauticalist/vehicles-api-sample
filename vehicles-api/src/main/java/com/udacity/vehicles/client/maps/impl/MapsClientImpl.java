package com.udacity.vehicles.client.maps.impl;

import com.udacity.vehicles.client.maps.MapsClient;
import com.udacity.vehicles.client.maps.dto.Address;
...
public class MapsClientImpl implements MapsClient {
    ...
    public MapsClientImpl(WebClient maps, ModelMapper mapper) {
        this.client = maps;
        this.mapper = mapper;
    }
